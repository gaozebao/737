...
#LotsoIntents
#./adr-sample-workflow-faults.sh LotsoIntents16Activities rohan.makes.intents LotsoIntents16ActivitiesActivity result -no-window

./adr-intents-noFaults.sh LotsoIntents16Activities rohan.makes.intents LotsoIntents16ActivitiesActivity result -no-window
